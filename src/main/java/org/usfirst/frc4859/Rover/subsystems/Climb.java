...
public class Climb extends Subsystem {
    ...
    private Encoder climbMotorEncoder;
    ...
    public Climb() {
        ...
        climbMotorEncoder = new Encoder(0, 2, false, EncodingType.k4X);
        addChild("ClimbMotorEncoder",climbMotorEncoder);
        climbMotorEncoder.setDistancePerPulse(1.0);
        climbMotorEncoder.setPIDSourceType(PIDSourceType.kRate);
