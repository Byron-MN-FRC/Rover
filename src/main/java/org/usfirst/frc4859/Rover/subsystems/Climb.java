...
public class Climb extends Subsystem {
    ...
    private AnalogInput leftKickStandIRSensor;
    private AnalogInput rightKickStandIRSensor;
    ...
    public Climb() {
        ...
        leftKickStandIRSensor = new AnalogInput(1);
        addChild("leftKickStandIRSensor",leftKickStandIRSensor);
        
        
        rightKickStandIRSensor = new AnalogInput(2);
        addChild("rightKickStandIRSensor",rightKickStandIRSensor);
        
        

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
   //     Constants.kFeetMotor = feetMotor;
   //     Constants.kGravityShifterSolenoid = gravityShifterSolenoid;
        motorConfig();
    }
