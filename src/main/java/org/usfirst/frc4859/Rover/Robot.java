...
public class Robot extends TimedRobot {
    ...
    public static HatchDeploy hatchDeploy;
    public static BallAquire ballAquire;
    public static BallLaunch ballLaunch;
    public static HatchGround hatchGround;
    public static Climb climb;
    public static Rocket rocket;
    public static LidarPulse lidarPulse;
    ...
    public void robotInit() {
        ...
        hatchDeploy = new HatchDeploy();
        ballAquire = new BallAquire();
        ballLaunch = new BallLaunch();
        hatchGround = new HatchGround();
        climb = new Climb();
        rocket = new Rocket();
        lidarPulse = new LidarPulse();
