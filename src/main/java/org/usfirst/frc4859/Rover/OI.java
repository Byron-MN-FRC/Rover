...
public class OI {
    ...
    public OI() {
        ...
        btnStartClimb.toggleWhenPressed(new StartClimb());
        ...
        SmartDashboard.putData("LowRocketHatch", new LowRocketHatch());
        SmartDashboard.putData("CargoBall", new CargoBall());
        SmartDashboard.putData("CargoHatch", new CargoHatch());
        SmartDashboard.putData("LowRocketBall", new LowRocketBall());
