...
public class OI {
    ...
    public JoystickButton btnCargoBallDeliver;
    public JoystickButton btnLiftPosLowRock;
    public JoystickButton btnMedRocketDeliver;
    ...
    public OI() {
        ...
        btnMedRocketDeliver = new JoystickButton(xBox, 3);
        btnMedRocketDeliver.whenPressed(new LiftSetPosition(2));
        btnLiftPosLowRock = new JoystickButton(xBox, 2);
        btnLiftPosLowRock.whenPressed(new LiftSetPosition(0));
        btnCargoBallDeliver = new JoystickButton(xBox, 1);
        btnCargoBallDeliver.whenPressed(new LiftSetPosition(1));
        ...
        SmartDashboard.putData("LiftSetPosition", new LiftSetPosition(0));
