...
public class OI {
    ...
    public JoystickButton button11AD;
    ...
    public OI() {
        ...
        button11AD = new JoystickButton(joystick, 11);
        button11AD.whenPressed(new AquireDeploy());
        ...
        SmartDashboard.putData("AquireRetract", new AquireRetract());
