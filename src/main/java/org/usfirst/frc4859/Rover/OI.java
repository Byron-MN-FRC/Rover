...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("targetRocket", new targetRocket());
        SmartDashboard.putData("targetNormal", new targetNormal());
        SmartDashboard.putData("targetCargo", new targetCargo());
