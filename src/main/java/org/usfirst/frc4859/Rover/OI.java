...
public class OI {
    ...
    public OI() {
        ...
        mediumRocketDeliver.whenPressed(new DeployCatapultMiddleRocket());
        lowRocketDeliver = new JoystickButton(xBox, 2);
        lowRocketDeliver.whenPressed(new DeployCatapultLowRocket());
        cargoBallDeliver = new JoystickButton(xBox, 1);
        cargoBallDeliver.whenPressed(new DeployCatapultCargo());
