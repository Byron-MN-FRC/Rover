 ...
 *
 */
public class DriveForwaredTimedTank extends Command {
    ...
    public DriveForwaredTimedTank(double timeInSeconds, double speed) {
    ...
    protected void execute() {
        Robot.driveTrainTank.driveTimedForward(m_speed);
    }
    ...
    @Override
    protected void end() {
        Robot.driveTrainTank.driveStop();
    }
